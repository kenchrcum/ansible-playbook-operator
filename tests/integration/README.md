...
docker build -t kenchrcum/ansible-playbook-operator:0.1.5 .

# Load images into kind
kind load docker-image kenchrcum/ansible-playbook-operator:0.1.5 --name ansible-operator-test
...
- Operator image: `kenchrcum/ansible-playbook-operator:0.1.5`
