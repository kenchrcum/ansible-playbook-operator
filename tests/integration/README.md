...
docker build -t kenchrcum/ansible-playbook-operator:0.1.7 .

# Load images into kind
kind load docker-image kenchrcum/ansible-playbook-operator:0.1.7 --name ansible-operator-test
...
- Operator image: `kenchrcum/ansible-playbook-operator:0.1.7`
