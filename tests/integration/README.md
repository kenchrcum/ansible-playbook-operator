...
docker build -t kenchrcum/ansible-playbook-operator:0.1.4 .

# Load images into kind
kind load docker-image kenchrcum/ansible-playbook-operator:0.1.4 --name ansible-operator-test
...
- Operator image: `kenchrcum/ansible-playbook-operator:0.1.4`
