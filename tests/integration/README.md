...
docker build -t kenchrcum/ansible-playbook-operator:0.1.3 .

# Load images into kind
kind load docker-image kenchrcum/ansible-playbook-operator:0.1.3 --name ansible-operator-test
...
- Operator image: `kenchrcum/ansible-playbook-operator:0.1.3`
